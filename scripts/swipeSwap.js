...
const ANNEXFARM = require("../artifacts/contracts/AnnexFarm.sol/AnnexFarm.json")

let ANNEXFARM_ADDRESS
let ANN_ADDRESS = "0xd57022d5cb065505093e2c4bbf7d683d2335ab6a"
...
async function deploy() {
  ...
  factory = new ethers.ContractFactory(ANNEXFARM.abi, ANNEXFARM.bytecode, walletWithProvider)
  ins = await factory.deploy(ANN_ADDRESS, deployer, "1000000000000000000", 9759275, 9859275, ETHER_SEND_CONFIG)
  await waitForMint(ins.deployTransaction.hash)
  ANNEXFARM_ADDRESS = ins.address
}
...
async function main() {
  ...
  await deploy()
  console.log(`
    ANNEXFARM_ADDRESS = ${ANNEXFARM_ADDRESS}
  `)
}
